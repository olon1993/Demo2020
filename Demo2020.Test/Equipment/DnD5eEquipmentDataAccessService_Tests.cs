...
{
    public class DnD5eEquipmentDataAccessService_Tests
    {
        [Fact]
        public async void GetAllEquipment_Test()
        {
            EquipmentDataAccessService equipmentApi = new EquipmentDataAccessService();
            List<Biz.Equipment.Models.EquipmentModel> equipments = await equipmentApi.GetAllEquipment();

            Assert.NotNull(equipments);
            Assert.Equal(237, equipments.Count);

            foreach (Biz.Equipment.Models.EquipmentModel equipment in equipments)
            {
        ...
        public async void GetEquipment_Test()
        {
            ...
            Biz.Equipment.Models.EquipmentModel container = null;
            foreach (Biz.Equipment.Models.EquipmentModel equipment in equipments)
            {
        ...
        {
            EquipmentDataAccessService equipmentApi = new EquipmentDataAccessService();
            Biz.Equipment.Models.EquipmentModel equipment = await equipmentApi.GetEquipment(name);
